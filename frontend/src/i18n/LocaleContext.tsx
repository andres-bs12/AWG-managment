...
const messages: Record<Locale, Dictionary> = {
  en: {
    ...
    formPhotosLead: 'You can add more than one.',
    formPhotosLeadMulti: 'Each ornament needs its own photos.',
    ornamentN: 'Ornament {n}',
    ornamentWithColor: 'Ornament {n} ({color})',
    addPhoto: 'Add photo',
  ...
  de: {
    ...
    formPhotosLead: 'Du kannst mehrere hinzufügen.',
    formPhotosLeadMulti: 'Jede Kugel braucht eigene Fotos.',
    ornamentN: 'Kugel {n}',
    ornamentWithColor: 'Kugel {n} ({color})',

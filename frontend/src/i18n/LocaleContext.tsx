...
const messages: Record<Locale, Dictionary> = {
  en: {
    ...
    ready: 'Ready for you',
    delivered: 'On its way / handed over',
    pickupWhen: 'When',
    whenFrom: 'from {time}',
    ...
    artReady: 'A wrapped Christmas box with the finished ornament',
  ...
  de: {
    ...
    artReady: 'Eine verpackte Weihnachtsbox mit der fertigen Kugel',
